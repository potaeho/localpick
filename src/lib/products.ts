...
export const products: Product[] = [
  /* ---------------- 가공식품 ---------------- */
  {
    ...
    detailImages: [
      ...
      "/product-details/sunchang-gochujang/3.png",
      "/product-details/sunchang-gochujang/4.png",
      "/product-details/sunchang-gochujang/5.png",
    ],
    regionId: "sunchang",
  ...
  },
  {
    ...
    detailImages: [
      ...
      "/product-details/gochang-bokbunja-vinegar/3.png",
      "/product-details/gochang-bokbunja-vinegar/4.png",
      "/product-details/gochang-bokbunja-vinegar/5.png",
    ],
    regionId: "gochang",
