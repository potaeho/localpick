...
export const creators: Creator[] = [
  ...
  },
  {
    ...
    since: "2014년",
    story:
      "복분자 농사를 짓다가 수확기에 몰리는 물량을 감당하지 못해 식초와 잼을 담그기 시작했습니다. 설탕을 넣어 빨리 발효시키는 대신, 열매의 당만으로 2년간 항아리에서 익힙니다.",
    philosophy:
  ...
  },
  {
    ...
    since: "1994년",
    story:
      "시어머니에게 장 담그는 법을 배워 30년 넘게 항아리를 지켜왔습니다. 메주는 직접 띄우고, 고춧가루는 인근 밭에서 그해 난 것만 씁니다. 물엿이나 밀가루로 양을 늘리지 않아 한 해에 담글 수 있는 양이 정해져 있습니다.",
    philosophy:
      "장은 손이 아니라 시간이 만듭니다. 빨리 팔려고 당을 넣으면 그 순간부터 장이 아니라 소스가 됩니다.",
  },
  {
    ...
    since: "2017년",
    story:
      "부모님이 하시던 닭갈비집 양념을 그대로 가져와 집에서도 해 먹을 수 있게 밀키트로 만들었습니다. 양념은 하루 재워 쓰고, 채소는 주문이 들어온 날 아침에 손질합니다.",
    philosophy:
      "가게에서 먹던 맛을 집에서 흉내 내는 게 아니라, 같은 양념을 그대로 보내는 것이 맞다고 생각했습니다.",
  },
  {
    id: "tongyeong-oyster",
    name: "정길수",
...
export const products: Product[] = [
  /* ---------------- 가공식품 ---------------- */
  {
    ...
    name: "순창 재래식 고추장 500g",
    tagline: "메주를 직접 띄워 담근 재래식 고추장",
    ...
    process: [
      "메주를 직접 띄워 씁니다",
      "그해 인근 밭에서 난 고춧가루만 사용합니다",
      "물엿과 밀가루로 양을 늘리지 않고 항아리에서 6개월 이상 익힙니다",
    ],
    notes:
      "재래식이라 시판 고추장보다 단맛이 약하고 짠맛이 뚜렷합니다. 개봉 후에는 냉장 보관해 주세요.",
  ...
  },
  {
    ...
    name: "춘천 닭갈비 밀키트 2인분",
    tagline: "가게에서 쓰는 양념 그대로 담은 밀키트",
    categoryId: "processed",
    imageKind: "mealkit",
    regionId: "chuncheon",
    creatorId: "chuncheon-dakgalbi",
    origin: "국내산 닭고기 (강원특별자치도 춘천시 가공)",
    priceList: 22000,
    priceSale: 17900,
    shippingFee: 3000,
    freeShippingOver: 40000,
    ...
    unit: "1세트 (2인분)",
    weight: "약 700g (닭다리살 400g, 채소 200g, 양념 100g)",
    expiry: "수령 후 냉장 5일",
    process: [
      "닭다리살만 손질해 사용합니다",
      "가게에서 쓰는 양념에 하루 재웁니다",
      "채소는 발송 당일 아침에 손질해 넣습니다",
    ],
    notes:
      "냉장 상품이라 소비기한이 짧습니다. 수령 후 5일 안에 조리해 주세요. 매운맛 조절은 어렵습니다.",
