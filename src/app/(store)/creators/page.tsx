...
export default function CreatorsIndexPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 lg:px-6 lg:py-8">
      <h1 className="text-lp-heading text-lp-ink sm:text-lp-page-heading">생산자</h1>
      <p className="mt-lp-md max-w-2xl text-sm leading-relaxed text-lp-gray-700">
        상품을 직접 기르고 만드는 사람들입니다.
      </p>

      <ul className="mt-lp-section grid gap-lp-md sm:grid-cols-2">
          ...
          return (
            <li key={creator.id}>
              <Link
                ...
                className="flex h-full items-start gap-lp-lg rounded-lp-card border border-lp-gray-300 bg-white p-lp-xl hover:border-lp-green focus:outline-none focus-visible:ring-2 focus-visible:ring-lp-green focus-visible:ring-offset-2"
              >
                <span
                  aria-hidden="true"
                ...
                <span className="min-w-0">
                  ...
                  <span className="mt-lp-sm block line-clamp-2 text-sm leading-relaxed text-lp-gray-700">
                    {creator.philosophy}
                  </span>
                </span>
              </Link>
